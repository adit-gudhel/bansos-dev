...
?>
        <tr>
            ...
            <td><input type="text" id="nil_opd_<?=$i?>" class="hibUangNilHibahTapd easyui-validatebox" name="nil_tapd_<?=$i?>" value="<?=$besaran_tapd?>" required="true" /></td>
...
$_sort=($sort=='desc')?"asc":"desc"; 
	...
	while($val=$result->FetchRow()){
		...
		<tr bgcolor=$bgcolor>
			...
			<td valign=top align='right'>".number_format($total_nilai_tapd,2,',','.')."</td>
			";
