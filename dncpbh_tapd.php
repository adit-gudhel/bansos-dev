...
$t->basicheader();
$f->checkaccess();
$t->title('Pelayanan - Pertimbangan Hibah TAPD - Download DNCPBH');
...
if(empty($row['kode'])){
	echo "<a href=evaluasi_hibah_tapd.php>Tidak ada DNCPBH</a>";
} else {
	$kode = $row['kode'];
	$tahun = $row['tahun'];
