...
$objPHPExcel->getProperties()->setCreator("Aditya Nursyahbani")
							 ...
							 ->setTitle("Daftar Penerima Hibah")
							 ->setSubject("Daftar Nama Penerima Hibah")
							 ->setDescription("Daftar Nama dan Alamat Penerima Hibah")
							 ->setKeywords("daftar penerima hibah")
							 ->setCategory("report");
...
$AS->mergeCells('A2:D2');
$AS->setCellValue('A2', 'ALOKASI BANTUAN HIBAH YANG DITERIMA');
