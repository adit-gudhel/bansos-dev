...
$GS["tdheadsort"]        = "<td class=tdbg2 bgcolor=%%CLR_SORTHEAD%%><a href=?%%SORTLINK_FIELDNAME%%><font color=black><b>%%FIELDNAME%%</b></font></a>&nbsp;&nbsp;%%SORTMARK%%</td>";
...
$GS["titlerow"]          = "<tr><td colspan=2 style='line-height: 30px; margin-bottom: 5px; border-bottom: dashed #999999 1px;' align=center><b class=PageTitle>%%TITLE%%</b></td></tr><tr><td colspan=2>&nbsp;</td></tr>";
...
// "Table Layout";
$GS["tdheadnumbering"]   = "<td class=tdbg><font color=black><b>No.</b>&nbsp;</font></td>";
$GS["tdheadaction"]      = "<td class=tdbg align=center nowrap><font color=black><b>Actions</b>&nbsp;</font></td>";
...
$GS["cancelcaption"]		 = " Batal ";
$GS["submitcaption"]		 = " Simpan ";
...
"
	...
	body              { font-family: Tahoma, Verdana, Arial; font-size: 11px; xmargin: 10;}
	...
	.bottomline			{ border-bottom:solid #c6c6c6 1px; border-left: dashed #c6c6c6 1px; }
	.tdbg					{ border-left: dashed #999999 1px; border-bottom: solid black 2px; background: url('x/i/siskka/tdheadbg.gif') #c6c6c6; line-height:20px; }
	.tdbg2				{ border-left: dashed #999999 1px; border-bottom: solid black 2px; background: url('x/i/siskka/tdheadbg2.gif') #999999; line-height:20px; }
	.tdbg3				{ border-bottom: solid black 2px; background: url('x/i/siskka/tdheadbg2.gif') #c6c6c6; }
	...
	.PageTitle			{ font-family: Arial, Book Antiqua; font-size:16px; color: #000000; text-align:center; }
	.tbl					{ padding: 8px; border-bottom: solid #c6c6c6 4px;
 							  background-color: white;
							  border-left: solid #c6c6c6 1px; border-top: solid #c6c6c6 4px;
	...
	.tdbuttonrow		{ padding: 10px; background-color: #ebebeb; border: solid #c9c9c9 1px; }
