...
$sql = "SELECT h.hib_kode as hib_kode, h.hib_nama as nama, h.hib_jalan as jalan, h.hib_rt as rt, h.hib_rw as rw, p.nm_propinsi as prop, d.nm_dati2 as dati2, kec.nm_kecamatan as kecamatan, kel.nm_kelurahan as kelurahan, h.hib_kodepos as kodepos, h.hib_tlp as no_tlp, h.hib_hp as no_hp, b.bank_nama as rekening, h.hib_norek as no_rekening, h.hib_besaran_hibah as besaran_hibah, bd.*, o.opd_nama as opd_tujuan FROM tbl_hibah h, tbl_propinsi p, tbl_dati2 d, tbl_kecamatan kec, tbl_kelurahan kel, tbl_bank b, tbl_opd o, tbl_berita_acara_detail bd WHERE h.kd_propinsi = p.kd_propinsi AND h.kd_dati2=d.kd_dati2 AND h.kd_kecamatan=kec.kd_kecamatan AND h.kd_kelurahan=kel.kd_kelurahan AND h.bank_kode=b.bank_kode AND h.opd_kode=o.opd_kode AND h.hib_eval_opd = '1' AND h.hib_eval_tapd = '0' AND (h.jh_kode = '2' or h.jh_kode = '3') AND bd.hib_kode=h.hib_kode AND h.hib_nama LIKE '%".$_REQUEST['term']."%'";
#die($sql);
