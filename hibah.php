...
<input type="hidden" name="id" value="<?=$hib_kode?>">
  ...
  <tr>
    <td>Tanggal</td>
    <td>
      <input type="text" name="hib_tanggal" id="hib_tanggal" value="<?=$f->convertdatetime(array("datetime"=>$hib_tanggal))?>" class="easyui-validatebox" required="true" />
    </td>
  </tr>
  <tr>
    <td colspan="2">&nbsp;</td>
  ...
  <tr>
    <td>Jenis Pemohon</td>
    <td>
      <?=$f->selectList("id_jp","tbl_jenis_pemohon","id_jp","jenis_pemohon",$id_jp,"","")?>
    </td>
  </tr>
  <tr>
    <td>Nama Pemohon</td>
  ...
  <tr>
    <td>Alamat</td>
    <td>
      <textarea name="hib_jalan" id="hib_jalan" cols="45" rows="5" class="easyui-validatebox" required="true" style="width:500px;" ><?=$hib_jalan?></textarea>
    </td>
  </tr>
  <tr>
    <td>RT / RW</td>
    <td>
      <input type="text" name="hib_rt" id="hib_rt" value="<?=$hib_rt?>" style="width:80px;" class="easyui-validatebox" required="true" />  / <input type="text" name="hib_rw" id="hib_rw" value="<?=$hib_rw?>" style="width:80px;" class="easyui-validatebox" required="true" />
    </td>
  </tr>
  <tr>
    <td>Propinsi</td>
  ...
  <tr>
    <td>No. Telp / HP</td>
    <td>
      <input type="text" name="hib_tlp" id="hib_tlp" value="<?=$hib_tlp?>" style="width:200px;" /> / <input type="text" name="hib_hp" id="hib_hp" value="<?=$hib_hp?>" style="width:200px;"  />
    </td>
  </tr>
  <tr>
    <td>Bank</td>
  ...
  <tr>
    <td>No. Rekening</td>
    <td>
      <input type="text" name="hib_norek" id="hib_norek" value="<?=$hib_norek?>" style="width:200px;" class="easyui-validatebox" required="true" />
    </td>
  </tr>
  <tr>
    <td colspan="2">&nbsp;</td>
  ...
  <tr>
  	...
  	<td>
      <textarea name="hib_lokasi_kegiatan" id="hib_lokasi_kegiatan" cols="45" rows="5" class="easyui-validatebox" required="true" style="width:500px;" ><?=$hib_lokasi_kegiatan?></textarea>
    </td>
  </tr>
  <tr>
    <td>Besaran Permohonan Hibah (Rp)</td>
    <td>
      <input type="text" name="hib_besaran_hibah" id="hib_besaran_hibah" value="<?=$hib_besaran_hibah?>" style="width:250px;" class="easyui-validatebox" required="true" />
    </td>
  </tr>
  <tr>
